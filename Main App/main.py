...
def main():
    st.set_page_config(initial_sidebar_state="expanded",
                       layout="centered",
        page_title="AlphaRep~AI GYM COACH", page_icon="./src/AlphaRep_icon.png")
    ...
    st.markdown("""
                <h1 style="margin-left:20px;"><span>Alpha</span><span style="color:red;font-family:serif">Rep</span></h1>
                <p style="font-size:2rem;font-family:serif;color:rgba(255,255,255,0.5)">Your Personal AI Coach</p>
